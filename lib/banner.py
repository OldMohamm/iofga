...
class Banner:
	def banner(self):
		print("_"*40)
		print("-==[ Iofga - Email OSINT ")
		print("-==[ Mohammed (OldMohamm) Amer ")
	...
	def usage(self,_exit_=False):
		...
		print("Example:")
		print("\tiofga.py --domain site.gov -v 3")
		print("\tiofga.py --info admin@site.gov -v 3")
		print("\tiofga.py --domain site.gov --source pgp --breach -v 1")
		print("\tiofga.py --domain site.gov --source google --breach --report site_gov.txt -v 3\n")
		if _exit_: exit(0)